...
public class GsonUtils {
    ...
    private static HashMap<String, GsonUtils> instances;
    ...
    private GsonUtils(ILogger logger) {
        this.logger = logger;
        initialization();
    }
    ...
    public static GsonUtils getInstance(ILogger logger) {
        if (logger == null) {
            return getInstance();
        }
        ...
        synchronized (LOCK) {
            if (instances == null) {
                instances = new HashMap<String, GsonUtils>();
            }
            if (!instances.containsKey(name)) {
                instances.put(name, new GsonUtils(logger));
            }
